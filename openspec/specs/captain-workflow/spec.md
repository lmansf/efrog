# captain-workflow Specification

## Purpose
Define the repo-local workflow that makes proposal-first planning, visual review, and no-mistakes validation discoverable to every future `efrog` contributor.
## Requirements
